...
{
    /// <inheritdoc />
    public partial class AddEmployeeInduction : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    InductionStatus = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_EmployeeInduction", x => x.EmployeeInductionId);
                    table.ForeignKey(
                        name: "FK_EmployeeInduction_Employee_EmployeeId",
                        column: x => x.EmployeeId,
                        principalSchema: "HR",
                        principalTable: "Employee",
                        principalColumn: "EmployeeId");
                    table.ForeignKey(
                        name: "FK_EmployeeInduction_InductionProgramMaster_InductionProgramMasterId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EmployeeInduction_EmployeeId_InductionProgramMasterId_IsActive",
                schema: "HR",
                table: "EmployeeInduction",
                columns: new[] { "EmployeeId", "InductionProgramMasterId", "IsActive" });

            migrationBuilder.CreateIndex(
                name: "IX_EmployeeInduction_InductionProgramMasterId",
                schema: "HR",
                table: "EmployeeInduction",
