        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OverallRecommendation = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_InterviewFeedbacks_ScheduledInterviews_ScheduledInterviewId",
                        column: x => x.ScheduledInterviewId,
                        principalTable: "ScheduledInterviews",
                        principalColumn: "ScheduledInterviewId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_InterviewFeedbacks_ScheduledInterviewId",
                table: "InterviewFeedbacks",
                column: "ScheduledInterviewId",
                unique: true);
        }
