...
{
    /// <inheritdoc />
    public partial class AddAvailabilitySlotResponse : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                name: "AvailabilitySlotResponses",
                columns: table => new
                {
                    AvailabilitySlotResponseId = table.Column<int>(type: "int", nullable: false)
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AvailabilitySlotResponses", x => x.AvailabilitySlotResponseId);
                    table.ForeignKey(
                        name: "FK_AvailabilitySlotResponses_AvailabilitySlots_AvailabilitySlotId",
                        column: x => x.AvailabilitySlotId,
                        principalTable: "AvailabilitySlots",
                        principalColumn: "AvailabilitySlotId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AvailabilitySlotResponses_Employee_EmployeeId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AvailabilitySlotResponses_AvailabilitySlotId_EmployeeId",
                table: "AvailabilitySlotResponses",
                columns: new[] { "AvailabilitySlotId", "EmployeeId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_AvailabilitySlotResponses_EmployeeId",
                table: "AvailabilitySlotResponses",
                column: "EmployeeId");
        }
