...
{
    /// <inheritdoc />
    public partial class AddApplicantModule : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ManpowerRequestId = table.Column<int>(type: "int", nullable: false),
                    SourceType = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    TotalExperience = table.Column<decimal>(type: "decimal(4,1)", nullable: false),
                    RelevantExperience = table.Column<decimal>(type: "decimal(4,1)", nullable: true),
                    ...
                    StageChangedOn = table.Column<DateTime>(type: "datetime2", nullable: false),
                    AppliedOn = table.Column<DateTime>(type: "datetime2", nullable: false),
                    RejectReason = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true),
                    RejectNotes = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Applicants_ManpowerRequest_ManpowerRequestId",
                        column: x => x.ManpowerRequestId,
                        principalSchema: "Recruitment",
                        principalTable: "ManpowerRequest",
                        principalColumn: "ManpowerRequestId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Applicants_ManpowerRequestId",
                table: "Applicants",
