...
{
    [Table("OnboardingEmployeeEmergencyContact", Schema = "HR")]
    public class OnboardingEmployeeEmergencyContact
    {
        [Key]
        public int OnboardingEmployeeEmergencyContactId { get; set; }
