...
{
    /// <inheritdoc />
    public partial class AddInductionProgramMaster : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                name: "InductionProgramMaster",
                schema: "HR",
                columns: table => new
                {
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_InductionProgramMaster", x => x.InductionProgramMasterId);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_InductionProgramMaster_ProgramCode",
                schema: "HR",
                table: "InductionProgramMaster",
                column: "ProgramCode",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_InductionProgramMaster_ProgramName",
                schema: "HR",
                table: "InductionProgramMaster",
                column: "ProgramName",
                unique: true);
